---
name: subprocess-auto-fix
type: orchestration
description: Detect and auto-fix common issues in posts
orchestration: parallel

---

# SUBPROCESS: Automatic Issue Detection and Fixing

## PURPOSE:

Detect and auto-fix common issues in posts

This subprocess enables parallel execution of fixing operations across multiple items.
