---
name: subprocess-metrics-aggregation
type: orchestration
description: Aggregate metrics from all post variants and outputs
orchestration: parallel

---

# SUBPROCESS: Metrics Aggregation Pipeline

## PURPOSE:

Aggregate metrics from all post variants and outputs

This subprocess enables parallel execution of analytics operations across multiple items.
