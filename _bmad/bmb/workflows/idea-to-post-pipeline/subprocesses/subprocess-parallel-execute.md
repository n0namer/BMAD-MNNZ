---
name: subprocess-parallel-execute
type: orchestration
...
# SUBPROCESS: Parallel Workflow Execution

## PURPOSE:

Execute multiple workflows simultaneously

This subprocess enables parallel execution of orchestration operations across multiple items.
