...
name: step-00-menu
nextStepFile_Create: ./mode-c/mode-c-00-menu.md
nextStepFile_Edit: ./mode-e/mode-e-00-menu.md
nextStepFile_Validate: ./mode-v/mode-v-00-menu.md
...
[1h] Управление базой
```
Load, read entire file, then execute `./mode-c-00-create-menu.md`

#### Option [2] - EDIT Mode:
```
Переходим в EDIT MODE...
```
Load, read entire file, then execute `./mode-e-00-edit-menu.md`

#### Option [3] - VALIDATE Mode:
```
Переходим в VALIDATE MODE...
```
Load, read entire file, then execute `./mode-v-00-validate-menu.md`
...
```
Load, read entire file, then execute `./mode-yolo/step-yolo-01-input.md`
