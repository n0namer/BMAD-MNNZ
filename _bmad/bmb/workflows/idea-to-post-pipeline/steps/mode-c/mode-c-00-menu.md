...
nextStepFile: ./mode-c-01/step-c-01-add-idea.md
...
```
Load, read entire file, then execute `./mode-c-04/step-c-04-search.md`
...
```
Load, read entire file, then execute `./mode-c-06/step-c-06a-select-posts.md`

**[7] ANALYTICS:**
```
Переходим к аналитике...
```
Load, read entire file, then execute `./mode-c-07/step-c-07a-dashboard.md`

**[8] MANAGE BASE:**
```
Переходим к управлению базой...
```
Load, read entire file, then execute `./mode-c-08/step-c-08a-backup.md`
