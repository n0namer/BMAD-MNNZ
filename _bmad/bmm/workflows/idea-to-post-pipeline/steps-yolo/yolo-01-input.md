...
nextStepFile: ./yolo-01b-ideas-input.md
...
### Purpose
This step acts as the "command center" for YOLO mode - it interprets your automation request and translates it into executable parameters. Think of it as a smart parser that understands flexible natural language instructions.

### Why It Exists
Without this step, the system wouldn't know WHAT to automate or HOW MUCH to create. This step bridges the gap between "I want posts" and "Create exactly 9 posts from 3 ideas with auto-validation".

### How It Fits
```
YOLO Pipeline:
┌─────────────┐    ┌──────────────┐    ┌─────────────┐
│ 01: INPUT   │ →  │ 01b: IDEAS   │ →  │ 02: EXECUTE │
│ (You are    │    │ (Collect     │    │ (Make it    │
│  here)      │    │  content)    │    │  happen)    │
└─────────────┘    └──────────────┘    └─────────────┘
```

### Common Pitfalls
❌ **Don't**: Assume the system will guess your intent
✅ **Do**: Be specific about counts ("3 ideas → 9 posts")

❌ **Don't**: Use vague requests ("make some posts")
✅ **Do**: Use clear instructions ("YOLO: 5 ideas, research + write")

❌ **Don't**: Skip confirmation
✅ **Do**: Always verify parameters before starting
