---
name: subprocess-batch-validation
type: orchestration
description: Validate multiple posts in batches with aggregated reporting
orchestration: parallel

---

# SUBPROCESS: Batch Quality Validation

## PURPOSE:

Validate multiple posts in batches with aggregated reporting

This subprocess enables parallel execution of validation operations across multiple items.
