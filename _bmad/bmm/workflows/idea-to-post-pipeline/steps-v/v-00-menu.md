...
```
Load, read entire file, then execute `./v-01a-load.md`

**[2] PERFORMANCE AUDIT:**
```
Анализирую метрики производительности...
```
Load, read entire file, then execute `./v-02a-load.md`

**[3] CONSISTENCY CHECK:**
```
Проверяю консистентность постов...
```
Load, read entire file, then execute `./v-03a-load.md`

**[4] COPY AUDIT:**
```
Аудирую качество копирайтинга...
```
Load, read entire file, then execute `./v-04a-load.md`

**[5] ENGAGEMENT CHECK:**
```
Прогнозирую потенциал взаимодействия...
```
Load, read entire file, then execute `./v-05a-load.md`

**[6] BATCH VALIDATE:**
```
Запускаю полную валидацию всего контента...
```
Load, read entire file, then execute `./v-06a-load.md`

**[7] VALIDATE IDEAS:**
```
Валидирую идеи перед исследованием...
```
Load, read entire file, then execute `./v-07a-load.md`

**[8] VALIDATION REPORT:**
```
Компилирую данные и генерирую отчёт...
```
Load, read entire file, then execute `./v-08a-compile.md`
