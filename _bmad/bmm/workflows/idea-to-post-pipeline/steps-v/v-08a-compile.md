...
nextStepFile: ./v-08b-generate.md
...
V-01: Quality Checklist
  Source: Session memory (V-01 results)
  Items: [N] posts evaluated
  Status: ✅ Retrieved

V-02: Performance Audit
  Source: Session memory (V-02 results)
  Items: [N] published posts analyzed
  Status: ✅ Retrieved

V-03: Consistency Check
  Source: Session memory (V-03 results)
  Items: [N] posts checked
  Status: ✅ Retrieved

V-04: Copy Audit
  Source: Session memory (V-04 results)
  Items: [N] posts audited
  Status: ✅ Retrieved

V-05: Engagement Check
  Source: Session memory (V-05 results)
  Items: [N] posts + [M] ideas predicted
  Status: ✅ Retrieved

V-06: Batch Validation
  Source: Session memory (V-06 results)
  Items: [N] items batch-validated
  Status: ✅ Retrieved

V-07: Idea Validation
  Source: Session memory (V-07 results)
  Items: [N] ideas validated
  Status: ✅ Retrieved

All data sources: ✅ COMPILED
Total validation records: [calculated] data points
```
